  ...
  return(
    <div className="flex flex-col items-center relative -z-0">
      ...
      <div className="flex flex-col items-center lg:flex-row gap-4 mx-auto max-w-6xl px-4 py-8">
        <div className="max-w-lg flex items-start flex-col space-y-5 text-white" data-aos="fade-right">
        ...
        <div className="flex w-full flex-col gap-16 items-end" data-aos="fade-left">
