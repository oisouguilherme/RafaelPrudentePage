...
export function Compromissos(){
  return (
    <div className='pb-20 mx-auto max-w-6xl px-4'>
      ...
      <div data-aos="fade-right" className='flex flex-col md:flex-row gap-8'>
        ...
        <div data-aos="fade-left" className='bg-white p-8 sm:p-16 rounded-2xl w-full flex flex-col justify-between items-start relative overflow-hidden xl:overflow-visible'>
